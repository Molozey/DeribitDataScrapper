...
try:
    ...
    from TradingInterfaceBot.ExternalModules.AbstractExternal import AbstractExternal
    from TradingInterfaceBot.InstrumentManager.AbstractInstrument import AbstractInstrument
