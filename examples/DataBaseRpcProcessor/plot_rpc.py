...
order_book_shape["TIME"] = pd.to_datetime(order_book_shape["TIME"], format='mixed')
...
trades_shape["TIME"] = pd.to_datetime(trades_shape["TIME"], format='mixed')
# order_book_shape.set_index("TIME")
plt.figure(figsize=(12, 6))
...
# print(rpc_order_book_shape.iloc[1529654:170585])
rpc_order_book_shape["TIME"] = pd.to_datetime(rpc_order_book_shape["TIME"], format='mixed')
# order_book_shape.set_index("TIME")
plt.figure(figsize=(12, 6))
...
rpc_trades_shape["TIME"] = pd.to_datetime(rpc_trades_shape["TIME"], format='mixed')
# order_book_shape.set_index("TIME")
plt.figure(figsize=(12, 6))
